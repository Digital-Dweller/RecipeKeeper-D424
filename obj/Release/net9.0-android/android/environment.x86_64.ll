...
@aot_dso_cache = dso_local local_unnamed_addr global [855 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-System.Security.Cryptography.Algorithms.dll.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Security.Cryptography.Primitives.dll.so
		ptr null; void* handle
	}, ; 69
	%struct.DSOCacheEntry {
		i64 u0x10b12fb83f00e605, ; from name: aot-Recipe Keeper.dll.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	}, ; 70
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Text.Encoding.Extensions.dll.so
		ptr null; void* handle
	}, ; 78
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3a87b317819db632, ; from name: Recipe Keeper.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x89cc351927370138, ; from name: libaot-Recipe Keeper.dll.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x94e8b19c702c3c5f, ; from name: aot-Recipe Keeper
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc539dc1989e90a72, ; from name: aot-Recipe Keeper.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc734951b1ce89d66, ; from name: Recipe Keeper
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xebcb543d15c7ffe2, ; from name: libaot-Recipe Keeper
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xec8c4f58c32a180e, ; from name: libaot-Recipe Keeper.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xff414898ccfaf901, ; from name: Recipe Keeper.dll.so
		i64 u0x89cc351927370138, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Recipe Keeper.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.recipekeeper\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [28 x i8] c"libaot-Recipe Keeper.dll.so\00", align 16
...
@.DSOCacheEntry.86_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Algorithms.dll.so\00", align 16
@.DSOCacheEntry.87_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Primitives.dll.so\00", align 16
@.DSOCacheEntry.88_name = private unnamed_addr constant [43 x i8] c"libaot-System.Security.Cryptography.dll.so\00", align 16
@.DSOCacheEntry.89_name = private unnamed_addr constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 16
